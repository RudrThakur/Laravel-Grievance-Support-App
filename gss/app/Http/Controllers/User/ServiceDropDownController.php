...
{
    public function subcategories(Request $request){//Listening to AJAX Requests
        if (!$request->category) {
    ...
    public function departments(Request $request){//Listening to AJAX Requests
        if (!$request->block) {
    ...
    public function floors(Request $request){//Listening to AJAX Requests
    ...
    public function rooms(Request $request){//Listening to AJAX Requests
